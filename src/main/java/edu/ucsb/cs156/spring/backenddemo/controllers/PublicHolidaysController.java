...
@Tag(name="Public Holiday Query Info from https://date.nager.at/Api")
@Slf4j
@RestController
...
public class PublicHolidaysController {
    ...
    public ResponseEntity<String> getPublicHolidays(
        ...
        @Parameter(name="countryCode", description="2 letter country code", example="UK") @RequestParam String countryCode
